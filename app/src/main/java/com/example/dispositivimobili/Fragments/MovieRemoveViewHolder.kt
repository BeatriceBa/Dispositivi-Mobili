...
class MovieRemoveViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
    RecyclerView.ViewHolder(inflater.inflate(R.layout.remove_films_layout, parent, false)) {
    ...
    init {
        ...
        mButton = itemView.findViewById(R.id.rmvToWatchBtn)
        mUrlView = itemView.findViewById(R.id.list_url)
        mButton.setOnClickListener {
            var jsonobject = JSONObject(URL("https://movieapi.magikarp.fun/removeToWatch?session=" + sessionID + "&movie=" + id).readText())
